...
# AI
# WITH AI
# ERROR: NO DISPLAY OF FLUCTUATION LOG
# WITH SIMULATION (START AND END DATE IS CORRECT)
# ADJUST AVERAGE
# REGARDING THE COMPUTATION OF AVERAGE OF 200 ROWS
# YES YOU GAVE ME EXACT 200 ROWS WITH CORRECT SERIAL NUMBER WHERE YOU DID STOP THE COUNTING
# BUT FOR THE FF PROCESS INSPECTION
# FOR VOLTAGE Middle (V) YOU GAVE ME 10.58 BUT THE CORRECT IS 10.55 SO THERE IS A DIFFERENCE OF -0.03
# FOR WATTAGE Middle (W) YOU GAVE ME 24.80 BUT THE CORRECT IS 24.85 SO THERE IS A DIFFERENCE OF 0.05
# FOR AMPERAGE Middle (A) HAS CORRECT COMPUTATION
# FOR CLOSED PRESSURE Middle (kPa) YOU GAVE ME 31.80 BUT THE CORRECT IS 31.70 SO THERE IS A DIFFERENCE OF -0.10
...
# 3RD TKINTER FOCUS
    ...
    def simulation(self):
        ...
        today = datetime(2025,10,14).date()
